              ...
              <PopoverContent className="w-72">
                ...
                <div className="flex flex-col text-gray-600 mt-3">
                  <div className="flex w-fit items-center gap-2 cursor-pointer">
                    <User2 />
                    <Button variant="link" tabIndex={-1}> <Link to="/profile">View Profile</Link></Button>
                  </div>
                  <div className="flex w-fit items-center gap-2 cursor-pointer">
                    <LogOut />
                    <Button variant="link" onClick ={logout} tabIndex={-1}>Logout</Button>
                  </div>
                </div>
              </PopoverContent>
            </Popover>
